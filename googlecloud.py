...
# pretrained_weights_path =  data_root+"sen1floods11_Prithvi_100M.pth"
num_layers = 12
patch_size = 16
embed_dim = 768
num_heads = 12
...
log_config = dict(
    ...
    hooks=[
        dict(
            type="TextLoggerHook",
            by_epoch=True,
            log_dir="/mightask_bucket1/logs/",  # Specify the directory to save text logs
        ),
        dict(
            type="TensorboardLoggerHook",
            by_epoch=True,
            log_dir="/mightask_bucket1/tensorboard_res/",  # Specify the directory to save TensorBoard logs
        ),
    ],
)
...
optimizer = dict(lr=1e-4)  # Lower LR
epochs = 300
